/**
 * The starting point for the plugin, pulled from a project 
 * The code below is awful (though it did work well for the site)
 * This has been transposed into proper plugin code but worth knowing where it came from 
 * 
 * 
 * 
 * 
